<template>
  ...
  <div class="pt-20 grid md:grid-cols-2" >
    <div class=" w-3/4 bg- h-52 p-6 rounded-md shadow-md flex flex-col items-center mr-2 ml-2">
      ...
      <div class="flex flex-col items-center">
          ...
          <div class="" v-if="selectedPaymentMethod === 'telebirr'">
            ...
            <div class="payment-details font-serif">
              <input v-model="telebirrAccountNumber" type="text" placeholder="Enter Account Number" class="payment-input" />
              <input v-model="telebirrNameHolder" type="text" placeholder="Enter Name Of Account Holder" class="payment-input" />
          ...
          <div class="payment-card" v-if="selectedPaymentMethod === 'hellocash'">
            ...
            <div class="payment-details font-serif">
              <input v-model="hellocashAccountNumber" type="text" placeholder="Enter Account Number" class="payment-input" />
              <input v-model="hellocashNameHolder" type="text" placeholder="Enter Name Of Account Holder" class="payment-input" />
              <input v-model="hellocashPassword" type="password" placeholder="Enter Password" class="payment-input" />
              <input v-model="hellocashPhonenumber" type="number" placeholder="Enter Phone Number" class="payment-input" />
            </div>
            <div class="flex flex-col items-center">
          ...
          <div class="payment-card" v-if="selectedPaymentMethod === 'cbe'">
            ...
            <div class="payment-details font-serif">
              ...
              <input v-model="cbeNameHolder" type="text" placeholder="Enter Name Of Account Holder" class="payment-input" />
          ...
          <!-- commercial payment card -->
           <div class="payment-card" v-if="selectedPaymentMethod === 'commercial'">
            ...
            <div class="payment-details font-serif">
              <input v-model="commercialAccountNumber" type="text" placeholder="Enter Account Number" class="payment-input" />
              <input v-model="commercialNameHolder" type="text" placeholder="Enter Name Of Account Holder" class="payment-input" />
              <input v-model="commercialPassword" type="password" placeholder="Enter Password" class="payment-input" />
              <input v-model="commercialPhonenumber" type="number" placeholder="Enter Phone Number" class="payment-input" />
            </div >
            <div class="flex flex-col items-center">
              <button @click="makePayment('cbe')" class="payment-button ">Pay with CBE</button>
            </div>
...
export default {
  ...
  if (this.isBenefitUuidStored) {
    const benefitUuid = localStorage.getItem("benefitUuid");
    const apiUrl = `http://157.175.203.69:8193/api/medicalinsurance/individualbenefit/${benefitUuid}`;
