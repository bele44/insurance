<template>
    <div class="flex justify-between items-center bg-blue-950 text-white fixed top-0 left-0 right-0 z-50 text-base">
      <!-- Left side: Family -->
      <div class="flex items-center">
        
       <!-- <i class="fas fa-ambulance text-2xl ml-10"></i> -->
       <img src="../assets/logo.png" alt="" class="" />
        <p class="font-bold text-xl ml-10">Non Health Insurance</p>
      </div>
      ...
      <!-- Package Panel -->
      <div v-if="isPackagePanelOpen" class="package-panel bg-gray-800">
        <!-- Health Insurance -->
        <router-link to="/health-insurance" class="cursor-pointer">
          ...
          <div class="column">
            <i class="fas fa-heart text-2xl"></i>
            <p class="text-sm">Condominium Insurance</p>
          </div>
          <div class="column">
            <i class="fas fa-heart text-2xl"></i>
            <p class="text-sm">Burglary and Housebreaking Insurance</p>
          </div>
        </router-link>
        ...
        <router-link to="/medical-insurance" class="cursor-pointer">
          ...
          <div class="column">
            <i class="fas fa-hospital text-2xl"></i>
            <p class="text-sm">Fidelity Guarantee Insurance</p>
          </div>
          <div class="column">
            <i class="fas fa-hospital text-2xl"></i>
            <p class="text-sm">Marine Cargo Insurance</p>
          </div>
        </router-link>
  
        <!-- Other Insurance -->
        <router-link to="/other-insurance" class="cursor-pointer">
          <div class="column">
            <i class="fas fa-shield-alt text-2xl"></i>
            <p class="text-sm">Money Insurance</p>
          </div>
              <div class="column">
            <i class="fas fa-shield-alt text-2xl"></i>
            <p >Motor Insurance</p>
      ...
      <div class="lg:ml-auto"><RightHeader/></div>
       <!-- Help Dialog Content -->
       <button @click="openHelpDialog" class="icon-button">
  ...
  export default {
    ...
    methods: {
      ...
      togglePackagePanel() {
        this.isPackagePanelOpen = !this.isPackagePanelOpen;
      },
    },
  };
  </script>
  ...
  .icon-button:hover .contact-info {
    display: block;
  }
  .help-dialog {
    display: block; /* Hide the dialog by default */
    position: absolute;
    top: 50px;
    left: 90%;
